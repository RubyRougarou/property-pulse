...
const EditPropertyForm = () => {
  ...
  // this is to get rid of the <div> in <div> html warning + the useEffect
  ...
  const handleChange = (e) => {
    ...
    if (name.includes(".")) {
      ...
      // for regular key-values objects like name
      setFields((prevFields) => ({
        ...prevFields,
        [name]: value,
      }));
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="block text-gray-700 font-bold mb-2">
            Listing Name <span className={"text-red-700"}>*</span>
          </label>
          <input
            type="text"
            id="name"
        ...
        <div className="mb-4 flex flex-wrap">
          ...
          <div className="w-full sm:w-1/3 px-2">
            <label
              ...
              className="block text-gray-700 font-bold mb-2"
            >
              Baths <span className={"text-red-700"}>*</span>
            </label>
            <input
              type="number"
              id="baths"
          ...
          <div className="w-full sm:w-1/3 pl-2">
            <label
              ...
              className="block text-gray-700 font-bold mb-2"
            >
              Square Feet <span className={"text-red-700"}>*</span>
            </label>
            <input
              type="number"
              id="square_feet"
        ...
        <div className="mb-4 bg-blue-50 p-4">
          <label className="block text-gray-700 font-bold mb-2">
            Rates (Leave blank if not applicable, fill at least one){" "}
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
            <div className="flex items-center">
              ...
              <input
                ...
                name="rates.weekly"
                className="border rounded w-full py-2 px-3"
                defaultValue={fields.rates.weekly}
                onChange={handleChange}
              />
            </div>
            <div className="flex items-center">
              ...
              <input
                ...
                name="rates.monthly"
                className="border rounded w-full py-2 px-3"
                defaultValue={fields.rates.monthly}
                onChange={handleChange}
              />
            </div>
            <div className="flex items-center">
              ...
              <input
                ...
                name="rates.nightly"
                className="border rounded w-full py-2 px-3"
                defaultValue={fields.rates.nightly}
                onChange={handleChange}
              />
            </div>
          </div>
        ...
        <div className="mb-4">
          <label
            ...
            className="block text-gray-700 font-bold mb-2"
          >
            Seller Email <span className={"text-red-700"}>*</span>
          </label>
          <input
            type="email"
            id="seller_email"
