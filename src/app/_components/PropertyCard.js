    ...
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-gray-500 mb-4">
          <p>
            <FaBed className={"inline mr-0.5"} /> {property.beds}
            <span className="md:hidden lg:inline"> Beds</span>
          </p>
          <p>
            <FaBath className={"inline mr-0.5"} /> {property.baths}
        ...
        <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
          ...
          {property.rates.weekly && (
            <p>
              <FaMoneyBill className={"inline mr-0.5"} /> weekly
            </p>
          )}
          {property.rates.monthly && (
            <p>
              <FaMoneyBill className={"inline mr-0.5"} /> monthly
            </p>
          )}
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          <div className="flex align-middle gap-2 mb-4 lg:mb-0">
            <FaMapMarker className={"inline text-orange-500 mr-0.5"} />
